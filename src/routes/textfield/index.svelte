...
<Play>
	...
	<div class="properties">
		<div>
			<Radio bind:group={type} value="default" title="default">default *</Radio>
			<Radio bind:group={type} value="filled">filled</Radio>
...
<script>
	import { Textfield, Checkbox, Radio } from 'svelte-mui/src';
